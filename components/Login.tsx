...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess, showToast }) => {
  ...
  // Login Form View
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4 sm:p-6 lg:p-8">
      <div className="bg-gray-800 p-6 sm:p-8 rounded-lg shadow-2xl w-full max-w-md border border-gray-700">
        
        {/* School Identity Section */}
        <div className="text-center mb-6 sm:mb-8">
            <div className="flex justify-center mb-4">
                {sekolah.logo_url ? (
                    <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white/5 rounded-full p-2 flex items-center justify-center border border-gray-600 shadow-inner">
                        <img 
                    ...
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-700 rounded-full flex items-center justify-center text-3xl sm:text-4xl border border-gray-600">
                        🏫
                    </div>
                )}
            </div>
            ...
            <p className="text-gray-400 text-xs sm:text-sm mt-1">Sistem Informasi Guru Wali</p>
        </div>
